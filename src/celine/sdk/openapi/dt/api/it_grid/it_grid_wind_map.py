...
from ...models.response_it_grid_wind_map import ResponseItGridWindMap
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/grid/{network_id}/wind/map".format(
...
) -> HTTPValidationError | ResponseItGridWindMap | None:
    if response.status_code == 200:
        response_200 = ResponseItGridWindMap.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[HTTPValidationError | ResponseItGridWindMap]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        HTTPValidationError | ResponseItGridWindMap
    """
