...
from ...models.response_it_grid_heat_map import ResponseItGridHeatMap
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/grid/{network_id}/heat/map".format(
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = ResponseItGridHeatMap.from_dict(response.json())
...
def sync(
    ...
    *,
    ...
    Returns:
        HTTPValidationError | ResponseItGridHeatMap
    """
