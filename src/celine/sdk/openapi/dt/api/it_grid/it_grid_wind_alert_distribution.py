...
from ...models.it_grid_wind_alert_distribution_response_200_item import ItGridWindAlertDistributionResponse200Item
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/grid/{network_id}/wind/alert-distribution".format(
...
) -> HTTPValidationError | list[ItGridWindAlertDistributionResponse200Item] | None:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = ItGridWindAlertDistributionResponse200Item.from_dict(response_200_item_data)
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[HTTPValidationError | list[ItGridWindAlertDistributionResponse200Item]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        HTTPValidationError | list[ItGridWindAlertDistributionResponse200Item]
    """
