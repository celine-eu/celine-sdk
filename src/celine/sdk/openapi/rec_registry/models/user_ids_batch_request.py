...
T = TypeVar("T", bound="UserIdsBatchRequest")


@_attrs_define
class UserIdsBatchRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        user_ids_batch_request = cls(
            user_ids=user_ids,
        )

        user_ids_batch_request.additional_properties = d
        return user_ids_batch_request
