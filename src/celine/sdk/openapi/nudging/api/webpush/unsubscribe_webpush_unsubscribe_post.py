...
def sync_detailed(
    *,
    ...
    """Remove a push subscription
     ...
     Disables the push subscription identified by endpoint for the authenticated user. The user identity
    is taken from the JWT – callers cannot remove others' subscriptions.

    Args:
        body (UnsubscribeRequest): user_id is derived from the JWT – not accepted from the caller.
