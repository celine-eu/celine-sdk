...
class SubmissionAdminRead:
    ...
    Attributes:
        ...
        dataspace_did (None | str):
        dataspace_subject_id (None | str):
        dataspace_vc_id (None | str):
        dataspace_vc_issued_at (datetime.datetime | None):
        email (None | str):
        extra_data (None | SubmissionAdminReadExtraDataType0):
        extracted_data (None | SubmissionAdminReadExtractedDataType0):
        first_name (None | str):
        ...
        id (UUID):
        id_extracted_data (None | SubmissionAdminReadIdExtractedDataType0):
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        dataspace_did: None | str
        dataspace_did = self.dataspace_did

        dataspace_subject_id: None | str
        dataspace_subject_id = self.dataspace_subject_id

        dataspace_vc_id: None | str
        dataspace_vc_id = self.dataspace_vc_id

        dataspace_vc_issued_at: None | str
        if isinstance(self.dataspace_vc_issued_at, datetime.datetime):
            dataspace_vc_issued_at = self.dataspace_vc_issued_at.isoformat()
        else:
            dataspace_vc_issued_at = self.dataspace_vc_issued_at

        email: None | str
        email = self.email

        extra_data: dict[str, Any] | None
        if isinstance(self.extra_data, SubmissionAdminReadExtraDataType0):
            extra_data = self.extra_data.to_dict()
        else:
            extra_data = self.extra_data

        extracted_data: dict[str, Any] | None
        if isinstance(self.extracted_data, SubmissionAdminReadExtractedDataType0):
        ...
        if isinstance(self.id_extracted_data, SubmissionAdminReadIdExtractedDataType0):
        ...
        field_dict.update(
            {
                ...
                "dataspace_did": dataspace_did,
                "dataspace_subject_id": dataspace_subject_id,
                "dataspace_vc_id": dataspace_vc_id,
                "dataspace_vc_issued_at": dataspace_vc_issued_at,
                "email": email,
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_dataspace_did(data: object) -> None | str:
            if data is None:
                return data
            return cast(None | str, data)

        dataspace_did = _parse_dataspace_did(d.pop("dataspace_did"))

        def _parse_dataspace_subject_id(data: object) -> None | str:
            if data is None:
                return data
            return cast(None | str, data)

        dataspace_subject_id = _parse_dataspace_subject_id(d.pop("dataspace_subject_id"))

        def _parse_dataspace_vc_id(data: object) -> None | str:
            if data is None:
                return data
            return cast(None | str, data)

        dataspace_vc_id = _parse_dataspace_vc_id(d.pop("dataspace_vc_id"))

        def _parse_dataspace_vc_issued_at(data: object) -> datetime.datetime | None:
            if data is None:
                return data
            try:
                if not isinstance(data, str):
                    raise TypeError()
                dataspace_vc_issued_at_type_0 = isoparse(data)

                return dataspace_vc_issued_at_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(datetime.datetime | None, data)

        dataspace_vc_issued_at = _parse_dataspace_vc_issued_at(d.pop("dataspace_vc_issued_at"))
        ...
        def _parse_extra_data(data: object) -> None | SubmissionAdminReadExtraDataType0:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                extra_data_type_0 = SubmissionAdminReadExtraDataType0.from_dict(data)

                return extra_data_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | SubmissionAdminReadExtraDataType0, data)

        extra_data = _parse_extra_data(d.pop("extra_data"))

        def _parse_extracted_data(data: object) -> None | SubmissionAdminReadExtractedDataType0:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                extracted_data_type_0 = SubmissionAdminReadExtractedDataType0.from_dict(data)

                return extracted_data_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | SubmissionAdminReadExtractedDataType0, data)
        ...
        def _parse_id_extracted_data(data: object) -> None | SubmissionAdminReadIdExtractedDataType0:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                id_extracted_data_type_0 = SubmissionAdminReadIdExtractedDataType0.from_dict(data)

                return id_extracted_data_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | SubmissionAdminReadIdExtractedDataType0, data)
