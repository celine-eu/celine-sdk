...
class TransitionRequest:
    ...
    Attributes:
        ...
        reason (None | str | Unset): Why. Required when rejecting — the participant is told, and an operator reopening
            the case months later needs to know.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        target = SubmissionStatus(d.pop("target"))
