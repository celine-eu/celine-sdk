...
class SubmissionRead:
    ...
    Attributes:
        ...
        email (None | str):
        extra_data (None | SubmissionReadExtraDataType0):
        extracted_data (None | SubmissionReadExtractedDataType0):
        first_name (None | str):
        ...
        id (UUID):
        id_extracted_data (None | SubmissionReadIdExtractedDataType0):
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.extra_data, SubmissionReadExtraDataType0):
            extra_data = self.extra_data.to_dict()
        else:
            extra_data = self.extra_data

        extracted_data: dict[str, Any] | None
        if isinstance(self.extracted_data, SubmissionReadExtractedDataType0):
        ...
        if isinstance(self.id_extracted_data, SubmissionReadIdExtractedDataType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_extra_data(data: object) -> None | SubmissionReadExtraDataType0:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                extra_data_type_0 = SubmissionReadExtraDataType0.from_dict(data)

                return extra_data_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | SubmissionReadExtraDataType0, data)

        extra_data = _parse_extra_data(d.pop("extra_data"))

        def _parse_extracted_data(data: object) -> None | SubmissionReadExtractedDataType0:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                extracted_data_type_0 = SubmissionReadExtractedDataType0.from_dict(data)

                return extracted_data_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | SubmissionReadExtractedDataType0, data)
        ...
        def _parse_id_extracted_data(data: object) -> None | SubmissionReadIdExtractedDataType0:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                id_extracted_data_type_0 = SubmissionReadIdExtractedDataType0.from_dict(data)

                return id_extracted_data_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | SubmissionReadIdExtractedDataType0, data)
